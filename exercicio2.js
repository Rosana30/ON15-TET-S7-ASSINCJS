 ...
 */ 
 ...
 const verificarPrecoDolar = await buscarPrecoDolar();
   const jurosImportacao = await buscarJurosImportacao();
   const valorEmReal = verificarPrecoDolar.comercial * precoEmDolar;
   const valorFinal = valorEmReal + (valorEmReal * jurosImportacao.juros1) +
    (valorEmReal * jurosImportacao.juros2);
